        ...
        <div className='mx-5 sm:mx-24 md:mx-40 lg:grid lg:grid-cols-2 lg:mx-0'>
            <div className='lg:flex lg:justify-end'>
                <div className='lg:mr-24 lg:w-80'>
                    ...
                    <MainButton onClick={() => console.log('ok')} style='mt-12 mb-16' text='Login to your Account' backgroundColor='bg-bw-orange' hoverBackgroundColor='bg-bw-hover-orange' textColor='text-bw-white' />
                </div>
            </div>
